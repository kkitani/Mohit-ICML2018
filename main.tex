...
In the above sections, we have shown the computational advantage of CCP-IRL for parameterized (linear and non-linear) reward functions. In the supplementary material, we further show how the CCP approach can be generalized to estimate the reward functions in a completely \textit{non-parameteric} setting.
