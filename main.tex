...
In this section, we introduce the MDP formulation as used in the econometrics literature under the name "Dynamic Discrete Choice Model". Following this, we show formulate the optimality equation and show how the resulting optimization problems relate to IRL algorithms in robotics.
