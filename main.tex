...
\textcolor{blue}{
To overcome this drawback, past work \cite{klein2012inverse, dvijotham2010inverse} has looked into methods that avoid the repeated computation. For instance, \cite{klein2012inverse} derive a structured classification framework while restricting themselves to linearly parameterized reward functions. \cite{dvijotham2010inverse} assume a different, linearly solvable MDP formulation, which allows efficient computation of the value function. 
