...
Despite these differences, we use SCIRL as another baseline to show the efficacy of expert CCP estimates as well as to highlight the generalizability of CCP-IRL to non-linear reward settings.
